...
(function ($)
{
    ...
    $(window).load(function () {
        ...
        setTimeout(function () { $('.menu-editor-adminify-loader').css({ 'display': 'none' }); }, 700)
        setTimeout(function () { $('.menu-editor-adminify--menu--editor--settings').addClass('loaded'); }, 700);
    });
    ...
    $('.menu-editor-adminify-icon-picker-wrap').ai_icon_picker({
    ...
    function adminify_menu_items_object(){
        ...
        $(".adminify_menu_item").each(function (index, element) {
            ...
            $(element)
                .find(".toplevel_page_menu-editor-adminify .menu_setting")
            ...
            if ($(element).find(".adminify_sub_menu_item").length > 0) {
                ...
                // console.log('clicked', submenu_object);
                $(element)
    ...
    function menu_editor_adminify_menu_items_accordion(){

        // Accordion

        jQuery(".menu-editor-adminify--menu--editor--container .accordion .accordion-body").css("display", "none");

        jQuery(".menu-editor-adminify--menu--editor--container .accordion-button, .menu-editor-adminify--menu--editor--container .accordion-opener").on('click', function (e)
        {
            e.preventDefault();
    ...
    menu_editor_adminify_menu_items_accordion();

    // Save Settings
    $('.menu-editor-adminify_menu_save_settings').on('click', function(e){
        e.preventDefault();
    ...
    // Menu Item Sort
    $(".menu-editor-adminify--menu--editor--settings").sortable({
        handle: ".menu-editor-title svg"
    });

    // Menu Item Submenu Sort
    $(".menu-editor-adminify--menu--editor--settings > .adminify_menu_item > .accordion-body > .tab-content > .tab-pane--submenu").sortable({
        handle: ".menu-editor-title svg"
    });
